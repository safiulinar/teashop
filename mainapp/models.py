...
class LatestProductsManager:
    ...
    def get_products_for_main_page(*args, **kwargs):
        ...
        for ct_model in ct_models:
            model_products = ct_model.model_class()._base_manager.all().order_by('-id')[:8]
...
class CategoryManager(models.Manager):
    ...
    CATEGORY_NAME_COUNT_NAME = {
        'Улун': 'teaproduct__count',
        'Пуэр': 'teaproduct__count',
        'Красный': 'teaproduct__count'
    }
    ...
    def get_categories_for_left_sidebar(self):
        models = get_models_for_count('teaproduct')
...
class TeaProduct(Product):
    ...
    region = models.CharField(max_length=45, verbose_name='Регион')
